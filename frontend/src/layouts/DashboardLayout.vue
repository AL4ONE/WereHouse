  ...
  <div class="app-shell">
    <nav class="topnav">
      ...
      <div class="nav-right">
        ...
        <button class="btn-icon" @click="toggleTheme" :title="isLightMode ? 'Dark Mode' : 'Light Mode'">
          <svg v-if="!isLightMode" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">

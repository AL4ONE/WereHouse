...
import { trainingPetugasNavLinks as navLinks } from '@/config/navLinks'
</script>
...
<template>
  <DashboardLayout :navLinks="navLinks">
    <div class="hero">
      <div class="hero-text">
        <h1>Welcome, <span class="gradient-text">Petugas Latihan</span></h1>
      </div>
    </div>

    <div class="cards">
      <router-link to="/training/staff/inventory-in" class="card">
      ...
      <router-link to="/training/staff/purchase-orders" class="card">
      ...
      <router-link to="/training/staff/inventory-out" class="card">
        <div class="card-glow orange"></div>
...
.card-glow.green, .card-glow.orange { background: #06b6d4; }

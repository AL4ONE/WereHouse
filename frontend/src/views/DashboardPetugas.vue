...
import { petugasNavLinks as navLinks } from '@/config/navLinks'
</script>
...
.card-icon-wrap.green { background: rgba(249,115,22,0.12); }
.card-icon-wrap.orange { background: rgba(249,115,22,0.12); }
